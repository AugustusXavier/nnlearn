...
import numpy as np
train_datadir = r'E:\python\week3\Cat-dog-recognition-based-on-CNN\big_data\train'
test_datadir  = r'E:\python\week3\Cat-dog-recognition-based-on-CNN\big_data\val'
...
if __name__ == "__main__":
    ...
    #保存完整模型
    torch.save(model.load_state_dict(), "model.pth")
    #读取
